  ...
  return (
    ...
    <div class="md:flex">
      <div class="md:shrink-0">
        <Image class="h-48 w-full object-cover md:h-full md:w-48 m-3" src="https://jdwd40.com/wp-content/uploads/2023/04/orbtal-media-1td5Iq5IvNc-unsplash.jpg" alt="random coding picture from upsplash" width='300' height='600' className='rounded-md'/>
      </div>
      <div class="p-8">
