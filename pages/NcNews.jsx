...
const NcNews = () => {
  ...
  <div class="md:flex">
    <div class="md:shrink-0">
      <Image class="h-48 w-full object-cover md:h-full md:w-48" src="https://jdwd40.tech/wp-content/uploads/2022/08/wp1-2.jpg" alt="random news pic from upspash"width='300' height='600' className='rounded-md'/>
    </div>
    <div class="p-8">
